...
export const data = [
	{
		...
		name: 'ImmoGram',
		nimi: 'ImmoGram',
		description: "This is my current project that I'm working on. The live version might be a bit outdated for this reason. Currently you can login with your own credentials, set your profile picture and create posts. You can also look for other peoples profiles and follow them and see their posts from your own profile. You can comment on posts and give post likes. You can delete your own posts and comments. My next plan for this project is to make it possible to return your forgotten password to your email.",
		kuvaus: 'Nykyinen projektini jonka parissa työskentelen. Tästä syystä live versio saattaa olla hieman jäljessä nykyisestä tilasta. Tällä hetkellä voit kirjautua sisään omilla tunnuksillasi, vaihtaa profiilikuvasi ja luoda posteja. Voit myös katsoa muiden käyttäjien profiileja, seurata heitä ja nähdä heidän luomansa postit omasta profiilistasi. Voit kommentoida posteihin ja antaa niille tykkäyksiä. Voit myös poistaa omia postejasi ja kommentejasi. Seuraavaksi yritän luoda projektiin salasanan palautuksen sähköpostiin.',
		problem: 'So far my biggest problem was with deleting comments. When I wanted to delete comment by clicking the delete button, the whole post got deleted. This was because I had some minor issues with finding the right comment id from the right post id and had some mix ups. In the end everything went well.',
		ongelma: 'Tähän asti suurin ongelmani oli kommentien poistaminen. Kun halusin poistaa kommentin, koko posti katosi. Minulla oli lieviä ongelmia löytää oikea kommentin tunnus oikeasta postin tunnuksesta ja tunnukset menivät vähän sekaisin. Lopulta sekin kuitenkin onnistui.',
		live: '',
