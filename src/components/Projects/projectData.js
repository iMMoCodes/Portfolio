...
export const data = [
	{
		...
		name: 'ImmoGram',
		nimi: 'ImmoGram',
		description: "This is my current project that I'm working on. Currently you can login, set your profile picture and create posts. You can also look / search for other peoples profiles and follow them and see their posts from your own profile. You can comment on posts and give them likes. You can delete your own posts and comments. Application also sends you welcome email when you sign up and you have possibility to retrieve forgotten password.",
		kuvaus: 'Nykyinen projektini jonka parissa työskentelen. Tällä hetkellä voit kirjautua sisään omilla tunnuksillasi, vaihtaa profiilikuvasi ja luoda posteja. Voit myös katsoa / etsiä muiden käyttäjien profiileja, seurata heitä ja nähdä heidän luomansa viestit omasta profiilistasi. Voit kommentoida posteihin ja antaa niille tykkäyksiä. Voit myös poistaa omia viestejäsi ja kommentejasi. Sovellus myös lähettää tervetuloa sähköpostin ja sinulla on mahdollisuus palauttaa unohtunut salasana.',
		...
		ongelma: 'Tähän asti suurin ongelmani oli kommentien poistaminen. Kun halusin poistaa kommentin, koko posti katosi. Minulla oli lieviä ongelmia löytää oikea kommentin tunnus oikeasta postin tunnuksesta ja tunnukset menivät vähän sekaisin.',
